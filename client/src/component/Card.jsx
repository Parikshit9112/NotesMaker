...
export const Card = ({ id, title, category, desc , date}) => {
  ...
  const data={"id":id,"title":title, "category":category, "desc":desc}
    ...
    <>
      <div className="col-md-4 single-note-item all-category" style={{}}>
        <div className="card card-body">
          ...
          <p className="note-category-date font-12 text-muted">{category}, {date}</p>
